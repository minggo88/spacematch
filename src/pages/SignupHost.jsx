...
import { User, Mail, Lock, Building, Phone, AlertCircle, Globe, Home, CheckCircle2, Loader2 } from 'lucide-react';
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input type="email" name="email" required value={formData.email} onChange={handleChange} onBlur={handleBlur} disabled={emailVerified}
                                    className={`${inputClass('email')} ${emailVerified ? 'bg-green-50 dark:bg-green-900/20 border-green-400 dark:border-green-600' : ''}`} placeholder="host@example.com" />
