...
import { X, Store, MapPin, Filter, Plus, Trash2, Camera, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, Clock, Users, Calendar, Minus, BarChart3, Tag } from 'lucide-react';
...
const VenueModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal Panel */}
            <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-scaleIn">
                ...
                <div className="p-6 md:p-8 border-b border-gray-100 flex justify-between items-center bg-white sticky top-0 z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-extrabold text-gray-900">{venue ? '공간 정보 수정' : isDuplicateMode ? '공간 복제 등록' : '새 공간 등록'}</h2>
                            <p className="text-sm text-gray-500">{venue ? '등록된 공간 정보를 수정합니다' : isDuplicateMode ? '기존 공간을 복제하여 새로 등록합니다' : '새로운 공간을 등록하여 서비스해보세요'}</p>
                        </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 custom-scrollbar">
                    <form id="venue-form" onSubmit={handleSubmit} className="space-y-6">
                        {/* Name */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2 is-required">공간 이름</label>
                            <input
                                required
                                name="name"
                                value={formData.name}
                                ...
                                className="w-full px-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all font-medium focus:ring-4 focus:ring-indigo-500/10"
                            />
                        </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 bg-gray-50 border border-transparent rounded-xl text-gray-500 font-medium cursor-not-allowed"
                                ...
                                <input
                                    ...
                                    onChange={handleFormChange}
                                    className="w-full px-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all font-medium"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">공간 유형</label>
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all appearance-none font-medium"
                                    >
                                ...
                                {!['popup', 'gallery', 'cafe', 'showroom', 'fleamarket'].includes(formData.type) && (
                                    <input
                                        ...
                                        className="mt-2 w-full px-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all font-medium"
                                    />
                                )}
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">공간 크기</label>
                                <div className="relative">
                                    <select
                                        name="size"
                                        value={formData.size}
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <select
                                        ...
                                        onChange={handleFormChange}
                                        className="w-1/3 px-2 py-3 bg-gray-50 border border-transparent rounded-xl focus:bg-white focus:border-indigo-500 outline-none font-medium text-sm"
                                    >
                                    ...
                                    <div className="relative flex-1">
                                        ...
                                        <input
                                            ...
                                            onChange={handleFormChange}
                                            placeholder="0"
                                            className="w-full pl-9 pr-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all font-bold text-gray-800"
                                        />
                                    </div>
                                </div>
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">수수료 (%)</label>
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-sm">%</span>
                                    <input
                                        type="number"
                            ...
                            {/* 모집 기간 설정 */}
                            <div className="col-span-2 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-100">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleFormChange}
                                            className="w-full px-4 py-3 bg-white border border-gray-200 focus:border-blue-500 rounded-xl outline-none transition-all font-medium"
                                        />
                                    </div>
                                    <div>
                            ...
                            {/* 행사 기간 설정 */}
                            <div className="col-span-2 bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
                                <div className="flex items-center gap-2 mb-3">
                                    <Calendar size={16} className="text-purple-600" />
                                    <label className="text-sm font-bold text-purple-800">행사 기간 설정</label>
                                    <div className="ml-auto flex items-center gap-2">
                                        ...
                                        <div className="flex items-center bg-white rounded-lg border border-purple-200 overflow-hidden">
                                            ...
                                            <input
                                                ...
                                                className="w-12 text-center py-1.5 text-sm font-bold text-purple-800 outline-none border-x border-purple-200 bg-transparent"
                                            />
                                            <button
                                                type="button"
                                                onClick={() => {
                                ...
                                <div className="space-y-3">
                                    {(formData.event_periods || []).map((period, idx) => (
                                        <div key={idx} className="bg-white/70 rounded-xl p-3 border border-purple-100">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-3 bg-white border border-gray-200 focus:border-purple-500 rounded-xl outline-none transition-all font-medium"
                                                    />
                                                </div>
                                                <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-4 rounded-xl border border-amber-100">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <label className="text-sm font-bold text-amber-800">평균 매출 (선택)</label>
                                </div>
                                <input
                                    type="text"
                                    name="avg_sales"
                                    ...
                                    className="w-full px-4 py-3 bg-white border border-gray-200 focus:border-amber-500 rounded-xl outline-none transition-all font-medium focus:ring-4 focus:ring-amber-500/10"
                                />
                                <p className="mt-2 text-xs text-gray-500">이 공간에서 예상되는 평균 매출을 입력하세요</p>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-teal-50 to-cyan-50 p-4 rounded-xl border border-teal-100">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <label className="text-sm font-bold text-teal-800">인기 카테고리 (선택)</label>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 bg-white border border-gray-200 focus:border-teal-500 rounded-lg outline-none text-xs font-medium"
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter') {
                                            e.preventDefault();
                                            const val = customCategory.trim();
                                            if (val && !(formData.popular_categories || []).includes(val)) {
                                                setFormData(prev => ({ ...prev, popular_categories: [...(prev.popular_categories || []), val] }));
                                                setCustomCategory('');
                                            }
                                        }
                                    }}
                        ...
                        {/* Description */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">공간 소개</label>
                            <textarea
                                name="description"
                                ...
                                className="w-full px-4 py-3 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-500 rounded-xl outline-none transition-all resize-none font-medium leading-relaxed"
                            />
                        </div>

                        {/* Images */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">📸 공간 이미지 갤러리</label>
                            <p className="text-xs text-gray-400 mb-3">첫 번째 사진이 대표 이미지로 사용됩니다. 드래그로 순서를 변경하세요.</p>
                            <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                                {formData.images.map((img, idx) => (
                                    <div key={idx} className="aspect-square rounded-xl bg-gray-100 overflow-hidden relative group border border-gray-200">
                                ...
                                {formData.images.length < 10 && (
                                    <div
                                        ...
                                        className="aspect-square rounded-xl border-2 border-dashed border-gray-300 hover:border-indigo-500 hover:bg-indigo-50/50 flex flex-col items-center justify-center text-gray-400 hover:text-indigo-600 transition-all gap-2 cursor-pointer group"
                                    >
                ...
                {/* Footer */}
                <div className="p-6 md:p-8 border-t border-gray-100 bg-gray-50 flex justify-between sticky bottom-0 z-10">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={onClose}
                            className="px-6 py-3.5 bg-white border border-gray-200 text-gray-700 rounded-xl font-bold hover:bg-gray-100 transition-colors"
                        >
                            취소
                        </button>
                        <button
