const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-ponyfill-DsGPdIuB.js","assets/vendor-icons-BFe5lkJJ.js"])))=>i.map(i=>d[i]);
import { r as reactExports } from "./vendor-icons-BFe5lkJJ.js";
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-DsGPdIuB.js").then((n) => n.b), true ? __vite__mapDeps([0,1]) : void 0).then(function(mod) {
